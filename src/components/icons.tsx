...
import { Infinity as InfinityIcon, Cloud as CloudIcon } from "lucide-react";
  ...
  return (
    <span {...props} className="flex items-center gap-2">
      <div className="relative flex items-center justify-center">
        <CloudIcon className="h-8 w-8 text-white/90" />
        <InfinityIcon className="absolute h-4 w-4 text-white" />
      </div>
